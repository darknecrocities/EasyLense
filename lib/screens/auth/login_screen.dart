...
import 'package:easylense_prototype/screens/auth/forgot_password_screen.dart';
                            ...
                            child: Checkbox(
                              ...
                              fillColor: MaterialStateProperty.resolveWith<Color?>((states) {
                                if (states.contains(MaterialState.selected)) {
                                  return const Color(0xFF08209A);
                                }
                                return Colors.black.withOpacity(0.05); // Very subtle gray fill
                              }),
                              side: BorderSide(
